...
app.get('/', function(req, res, next) {
    req.getConnection(function(error, conn) {
        conn.query('SELECT * FROM customer_info ORDER BY id DESC',function(err, rows, fields) {
            //if(err) throw err
            if (err) {
                req.flash('error', err)
...
/*app.post('/add', [
   ...
   (req, res) => {
    ...
    req.getConnection(function(error, conn) {
        conn.query('INSERT INTO customer_info SET ?', item, function(err, result) {
            //if(err) throw err
            if (err) {
                req.flash('error', err)
...
app.get('/edit/(:id)', function(req, res, next){
    req.getConnection(function(error, conn) {
        conn.query('SELECT * FROM todolist WHERE id = ' + req.params.id, function(err, rows, fields) {
            if(err) throw err
